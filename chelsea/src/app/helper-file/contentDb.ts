...
export const contentArray: Content[] = [
  ...
  {
    id: 5,
    title: 'Our Best Manager',
    description: 'This manager is the best manager the world has seen and also the best for the club',
    creator: 'Abdulrhman',
  ...
  },
  {
    ...
    description: 'This player is one of the youngest in the team and has already had a significant impact in the best way possible',
    creator: 'Abdulrhman',
  ...
  {
    id: 7,
    title: 'Our Top Scorer of All Time',
    description: 'This player has scored the most goals for our team and is one of the best players too',
    creator: 'Abdulrhman',
