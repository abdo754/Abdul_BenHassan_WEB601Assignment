...
export class ContentCardComponent {
  ...
  constructor() {
    ...
    this.contentList.add({ id: 3, title: 'The Stadium', description: 'The home of Chelsea', creator: 'Abdulrhman', imgURL:'https://arquitecturaviva.com/assets/uploads/obras/40781/av_thumb__av_imagen.webp' });
  }
